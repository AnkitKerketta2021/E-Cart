...
function NavBar() {
  return (
   ...
   <Navbar bg="primary" variant="dark" expand="lg">
    <Container>
    <Navbar.Brand href="#home"><img className="imagg" src="http://wp.usatodaysports.com/wp-content/uploads/sites/90/2013/06/b9hvwjslf7jzh18ej6y4.gif" alt="img" /></Navbar.Brand>
    <Navbar.Toggle aria-controls="navbarScroll" />e
